...
$sql="INSERT INTO  tblsubjects(SubjectName,SubjectCode,TeacherName) VALUES(:subjectname,:subjectcode,:teachername)";
...
<div class="form-group">
 ...
 <input type="text" name="subjectcode" class="form-control" id="default" placeholder="Subject Code" required="required">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="teachername" class="form-control" id="default" placeholder="Teacher Name" required="required">
                                                        </div>
